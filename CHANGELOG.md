...
- Add output\_format and handle\_when parameters for checks [\#26](https://github.com/sensu/puppet-module-sensuclassic/pull/26) ([treydock](https://github.com/treydock))
...
- Feature request: Add ability to have configuration changes reload sensu-enterprise instead issuing a restart [\#17](https://github.com/sensu/puppet-module-sensuclassic/issues/17)
